#!/usr/bin/env python3
"""
Basic smoke tests for the INAV Toolkit.

Run: python3 tests/test_smoke.py
  or: python3 -m pytest tests/test_smoke.py
"""
import json
import os
import subprocess
...
def run_module(module, *args):
    """Run a toolkit module via python -m."""
...
def test_filter_math():
    ...
    print("\n── Filter Math ──")
    from inav_toolkit.blackbox_analyzer import _phase_shift, estimate_filter_phase_lag
    import numpy as np
...
def test_param_analyzer_setup():
    ...
    # 10-inch 6S
    out, err, rc = run_module("inav_toolkit.param_analyzer", "--setup", "10", "--voltage", "6S")
...
def test_blackbox_import():
    ...
    try:
        ...
        test("Has REPORT_VERSION", REPORT_VERSION is not None)
